...
[[maybe_unused]]
static const char *pshine_vk_layout_string(VkImageLayout layout) {
	switch (layout) {
    ...
    case VK_IMAGE_LAYOUT_FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR: return "FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR";
    ...
    case VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT: return "ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT";
    case VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM: return "TENSOR_ALIASING_ARM";
    case VK_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR: return "VIDEO_ENCODE_QUANTIZATION_MAP_KHR";
